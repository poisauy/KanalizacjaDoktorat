...
handles.modebutton = ...
  uicontrol('Style','Popup','Position',[641 1 140 22], ...
    'Value',1,'String',{'Zapis Napiêcia','Napiêcie na Zacisku'}, ...
    'FontSize',9, 'Tooltip','Toggle Voltage Clamp mode', ...
    'CallBack','callbacks(23)');
...
handles.membutton = ...
  uicontrol('Style','CheckBox','Position',[bx toprowy bw bh], ...
    'Value',0,'String','Mêbrana','FontSize',9, ...
...
handles.chanbutton = ...
  uicontrol('Style','CheckBox','Position',[bx toprowy bw bh], ...
    'Value',0,'String','Kana³','FontSize',9, ...
...
handles.stimbutton = ...
  uicontrol('Style','CheckBox','Position',[bx toprowy bw bh], ...
    'Value',0,'String','Bodziec','FontSize',9, ...
...
handles.drugbutton = ...
  uicontrol('Style','CheckBox','Position',[bx toprowy bw bh], ...
    'Value',0,'String','Iniekcja','FontSize',9, ...
    'HorizontalAlignment','left', ...
...
handles.runbutton = ...
  uicontrol('Style','PushButton','Position',[130 1 65 20], ...
	'String','Uruchom','FontSize',9,'BackgroundColor',[0.4 1 0.4], ...
	'Tooltip','Run simulation', ...
	'CallBack','run_system(2)');

handles.nudgebutton = ...
  uicontrol('Style','PushButton','Position',[200 1 75 20], ...
	'String','Przesuniêcie','FontSize',9,'BackgroundColor',[0.8 0.8 0.4], ...
...
handles.printbutton = ...
  ...
  'String','Drukuj','FontSize',9, ...
  'Tooltip','Zapis do pliku', ...
  'Callback','print_data;');
...
handles.zoombutton = ...
    uicontrol('Style', 'togglebutton', 'Position', [490 3 75 20], ...
    'String', 'Powiêksz', 'FontSize', 9, ...
    'CallBack', 'radiobuttons(1)', 'visible', 'on', 'ForegroundColor', 'k', ...
    'value', 0);

handles.panbutton = ...
    uicontrol('Style', 'togglebutton', 'Position', [565 3 65 20], ...
    'String', 'Pan', 'FontSize', 9, ...
    'CallBack', 'radiobuttons(2)', 'visible', 'on', 'ForegroundColor', 'k', ...
    'value',  0);

handles.cursorbutton = ...
    uicontrol('Style', 'togglebutton', 'Position', [427 3 65 20], ...
    'String', 'Kursor', 'FontSize', 9, ...
...
handles.zoom_instruction = uicontrol('Style','text', ...
    'Position',[620 45 250 65], ...
    'BackgroundColor',0.15*[1 1 1], ...
    'ForegroundColor','r', ...
    'String','Kliknij lewym przyciskiem myszy, aby powiêkszyæ, kliknij prawym przyciskiem myszy,', ...
    'visible', 'off');
